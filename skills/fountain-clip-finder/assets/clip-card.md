...
<!-- {source} names the episode or external video, and {source_published} is its publish date when known. -->
<!-- The reader judges an old moment differently, so omit only a date that the source does not provide. -->
